...
<body>
    ...
    <div id="eventAddModal" style="display: none">
        <form action="../backEnd/byteController.php?method_finder=create" method="post" onsubmit="return validateEvent();">
        <h3>Create Event</h3> 
            <div>
            ...
            <div>
                ...
                <p id="error" style="display:none; color:red; font-weight:bold;">Event end date cannot be earlier than event start date.</p>
            </div>
            <br>
            <div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form id="editForm" action="../backEnd/byteController.php?method_finder=edit" method="post" >
