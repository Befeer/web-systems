...
<body>
    ...
    <div>
        <form action="../backEnd/lisaController.php?method_finder=update" method="post">
            ...
            <br>
            <br>
            <button onclick="window.location.href='lisa.php'">Cancel</button>
        </form>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="../backEnd/lisaController.php?method_finder=edit" method="post">
