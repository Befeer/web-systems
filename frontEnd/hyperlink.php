...
<body>
    ...
    <div id="eventAddModal" style="display: none">
        <form action="../backEnd/hyperlinkController.php?method_finder=create" method="post" onsubmit="return validateEvent();">
        <h3>Create Event</h3>    
            <div>
    ...
    <div id="eventEditModal" style="display: flex">
        <form action="../backEnd/hyperlinkController.php?method_finder=update" method="post">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="../backEnd/hyperlinkController.php?method_finder=edit" method="post">
                            <input type="hidden" name="method_finder" value="edit">
                            <input type="hidden" name="id" value="<?= htmlspecialchars($event['id'])?>">
                            <button type="submit">edit</button>
                        </form>
                        <form action="../backEnd/hyperlinkController.php?method_finder=delete" method="get" style="display: inline;">
